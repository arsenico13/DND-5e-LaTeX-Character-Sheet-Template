...
\AddWeapon{Quarterstaff}{+2}{1d6 b}
\AddWeapon{Shillelagh}{+5}{1d8+3 b}
...
\textbf{Lingue:}\\Comune, Druidico, Nanico, Elfico, Goblin\\
\textbf{Armor:}\\Armature leggere e medie\\
\textbf{Armi:}\\Club, Daggers, dart, javalein, mace, slings, quarterstaffs, scimitar, spear\\
\textbf{Tools:}\\Kit erbalista\\
}

\Equipment{
acciarino e pietra focaia,
corca di canapa (50ft.),
cuoio,
gavetta,
inchiostro (1 ounce),
otre,
...
\PersonalityTraits{
I’m willing to listen to every side of an argument before I make my own judgment. I am also horribly, horribly awkward in social situations.
}
...
\Bonds{
My life’s work is a series of tomes related to astronomy.
}
...
\textbf{Druidic}
\begin{itemize}
  \item You know Druidic, the secret language of druids.
\end{itemize}
\textbf{Spellcasting}
\begin{itemize}
  \item You can cast prepared druid spells using WIS as your spellcasting modifier (Spell DC 13, Spell Attack +5) and prepared druid spells as rituals if they have the ritual tag. You can use a druidic focus as a spellcasting focus.
\end{itemize}
}
...
\CantripSlotB{Shillelagh (V, S, M), (+5, 1d8+3 b) D: 1min}
\CantripSlotC{ }
\CantripSlotD{ }
\CantripSlotE{ }
\CantripSlotF{ }
...
\FirstLevelSpellSlotA{Animal Friendship (V, S, M), D:24h}
\FirstLevelSpellSlotB{Faerie Fire (V), D:1min, 20ft. square}
\FirstLevelSpellSlotC{Healing word (V)}
\FirstLevelSpellSlotD{Ice knife (V, S, M) (+5, 1d10 f)}
\FirstLevelSpellSlotE{Thunderwave (V, S) (CON 13, 2d8)}
