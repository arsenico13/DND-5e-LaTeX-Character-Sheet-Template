...
\PerceptionSkillModifier{-1} % +5 Observant
...
\WisdomProficiency{True}   % Warlock
\CharismaProficiency{True} % Warlock
...
\AddWeapon{Dagger}{+3}{1d4+1 p}
\AddWeapon{Eldritch Blast}{+5}{1d10+3 f}
\AddWeapon{Unarmed Strike}{+2}{1 b}

\AttacksAdditional{
\textbf{Dark One’s Blessing:}\\When you reduce a hostile creature to 0 HP, you gain 5 temp HP.\\
\textbf{    }\\    \\
}

\OtherProficienciesLanguages{
\textbf{Lingue:}\\Comune, Elfico, Gnomico, Infernale\\
\textbf{Armor:}\\Armature leggere\\
\textbf{Armi:}\\(Simple weapons) Daggers, darts, slings, quarterstaffs, light crossbows\\
\textbf{Tools:}\\...
}
...
orb (arcane focus),
libro,
2x Inchiostro (1 ounce),
Penna,
10x Foglio di pergamena,
Sacchetto con sabbia,
Piccolo coltello
}
...
\FeaturesTraits{
\textbf{Otherworldly Patron}
\begin{itemize}
  \item You have struck a bargain with an otherworldly being.
\end{itemize}
\textbf{Pact Magic}
\begin{itemize}
  \item You can cast known warlock spells using CHA as your spellcasting modifier (Spell DC 13, Spell Attack +5). You can use an arcane focus as a spellcasting focus.
\end{itemize}
\textbf{Dark One’s Blessing}
\begin{itemize}
  \item When you reduce a hostile creature to 0 HP, you gain 5 temp HP.
\end{itemize}
\textbf{Eldritch Invocations}
\begin{itemize}
  \item Agonizing Blast: When you cast eldritch blast, add +3 to the damage it deals on a hit.
  \item Armor of Shadows: When you cast eldritch blast, add +3 to the damage it deals on a hit (già incluso).
\end{itemize}
\textbf{Darkvision}
\begin{itemize}
  \item You can see in darkness (shades of gray) up to 60 ft.
\end{itemize}
\textbf{Hellish Resistance}
\begin{itemize}
  \item You have resistance to fire damage.
\end{itemize}
\textbf{Infernal Legacy}
\begin{itemize}
  \item You know the thaumaturgy cantrip. [3rd] You can cast hellish rebuke (2nd) once per long rest. [5th] You can cast darkness once per long rest. CHA is your spellcasting ability.
\end{itemize}
}
...
\Characterbackground{
You spent years learning the lore of the multiverse. You scoured manuscripts, studied scrolls, and listened to the greatest experts on the subjects that interest you. Your efforts have made you a master researcher.
}
\Treasure{
...
\CantripSlotB{Prestidigitation (V, S), D: 1h}
\CantripSlotC{Thaumaturgy (V), D: 1m}
...
\FirstLevelSpellSlotA{Charm Person (V, S), D: 1h}
\FirstLevelSpellSlotB{Witch Bolt (V, S, M)}
\FirstLevelSpellSlotC{Burning Hands (V, S) 15ft. Cone}
\FirstLevelSpellSlotD{Mage Armor (V, S, M), D: 8h}
