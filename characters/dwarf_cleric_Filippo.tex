...
\WisdomScore{16} % +1 per Nano delle colline
\CharismaScore{12}
...
\AddWeapon{Warhammer}{+4}{1d8+2 cont}
\AddWeapon{Balestra leggera}{-1}{1d8-1 perf}
\AddWeapon{Fiamma Sacra}{DC 13}{1d8 radiante}

\AttacksAdditional{
\textbf{Balestra leggera:}\\range 80/320ft, due mani\\
\textbf{Fiamma Sacra:}\\Tiro salvezza DES, DC 13, range 60ft. Il bersaglio no bonus copertura\\
}

\OtherProficienciesLanguages{
\textbf{Lingue:}\\Comune, Nanico\\
\textbf{Armatura:}\\Armature leggere, armature medie, armature pesanti, scudi\\
\textbf{Armi:}\\Armi da mischia semplici, ascia da battalia, ascia, martello leggero, warhammer\\
\textbf{Strumenti:}\\Strumenti da Fabbro
}
...
\FeaturesTraits{
\textbf{Oscurovisione:}\\in condizioni di luce fioca puoi vedere fino a 60ft come se ti trovassi in luce intensa e nell'oscurità come se fosse luce fioca. Nell'oscurità non sei in grado di discernere i colori ma solo le tonalità di grigio.\\
\textbf{Resilienza naninca:}\\disponi di vantaggio ai tiri salvezza contro il veleno; hai resistenza ai danni da veleno\\
\textbf{Esperto minatore:}\\se effettui una prova di INT(Storia) relativa all'origine di una struttura in pietra, si considera avere competenza in Storia e si aggiunge il doppio del bonus di compoetenza\\
\textbf{Robustezza naninca:}\\il massimo dei punti ferita di un nano delle colline aumenta di 1 e aumenta di nuovo di 1 ogni volta che acquisisce un livello\\
\textbf{Incantesimi}
\begin{itemize}
  \item La tua caratteristica per gli incantesimi è Saggezza
  \item Spell Save DC: 13
  \item Spell Attack Bonus: +5
  \item Il numero di incantesimi da preparare è pari a SAG + livello
  \item Gli incantesimi del proprio dominio non contano nel determinare il numero degli incantesimi preparati
\end{itemize}
\textbf{Livello 1}
\begin{itemize}
  \item Trucchetti: 3 conosciuti
  \item Incantesimi: 4 da preparare
  \item Slot incantesimi 1° livello: 2
\end{itemize}
}
...
\FirstLevelSpellSlotA{Dominio: bless}
\FirstLevelSpellSlotB{Dominio: cure wounds}
\FirstLevelSpellSlotC{Command}
\FirstLevelSpellSlotD{detect evil and good}
\FirstLevelSpellSlotE{guiding bolt}
\FirstLevelSpellSlotF{Shield of faith}
