...
\ConstitutionProficiency{} % Bardo
\IntelligenceProficiency{}
\WisdomProficiency{}
\CharismaProficiency{True} % Bardo

\AcrobaticsProficiency{True} % Bardo
...
\InvestigationProficiency{True}
\MedicineProficiency{}
\NatureProficiency{}
\PerceptionProficiency{}
\PerformanceProficiency{True}
...
\AddWeapon{Pugnale}{+5}{1d4+1 perf}
\AddWeapon{Stocco}{+5}{1d8+3 perf}


\AttacksAdditional{
\textbf{Pugnale:}\\anche a distanza 20/60ft.\\
}

\OtherProficienciesLanguages{
\textbf{Languages:}\\Comune, Elfico, Goblin\\
\textbf{Armor:}\\Arm. leggere\\
\textbf{Weapons:}\\Armi da mischia semplici, Balestra a mano, Spada lunga, stocco, spada corta\\
\textbf{Strumenti musicali:}\\Liuto, cornamusa, tamburo\\
}
...
\textbf{Retaggio Fatato:}\\disponi di vantaggio ai tiri salvezza per non essere affascinato e non puoi essere addormentato tramite la magia.\\
\textbf{Ispirazione bardica}\\3 per ogni riposo lungo\\
\textbf{Incantesimi}
\begin{itemize}
  \item La tua caratteristica per gli incantesimi è Carisma
  \item Spell Save DC: 13
  \item Spell Attack Bonus: +5
\end{itemize}
\textbf{Livello 1}
\begin{itemize}
  \item Trucchetti: 2 conosciuti
  \item Incantesimi: 4 conosciuti
